...
class Run(object):
    ...
    def checkFEP(self):
        ...
        if self.dual == True:
            ...
            self.FEPlist = ['FEP1.fep', 'FEP2.fep', 'FEP3.fep', 'FEP4.fep', 'FEP5.fep']
            self.FEPdir = None
    ...
    def readpdb(self):
        ...
        self.backbone = ['C', 'O', 'CA', 'N', 'H', 'HA', 'HA2'] # Edit Lucien: it was also decharging backbone HA2 of GLY
    ...
    def create_dual_lib(self):
        ...
        # Construct atom name replacements #TODO very ugly piece of code, needs restyling
        if len(self.mutation[2]) == 1:
    ...
    def get_zeroforcebonded(self):
        ...
        qprep = s.Q_DIR[self.preplocation] + 'qprep5'
    ...
    def write_dualFEPfile(self):
        ...
        ## Edit_lucien: this should actually be 3 FEP files, state 1: VWD+C -> soft+noC -> DUM -> DUM
        ##                                                   state 2: DUM -> DUM -> soft+n0C -> VDW+C 
        for fepfile in self.FEPlist:
            with open(self.directory + '/inputfiles/' + fepfile, 'w') as outfile:
                ...
                for line in self.merged_lib['[atoms]']:
                    ...
                    if line[1][0].islower() == False:
                        if line[1] in self.backbone:                                    
                            ...
                            if fepfile in ['FEP1.fep', 'FEP2.fep']:
                                    outfile.write('{:4d}{:>10s}{:>10s}\n'.format(cnt, 
                                                                                 line[3], 
                                                                                 line[3]))
                            elif fepfile in ['FEP3.fep']:
                                outfile.write('{:4d}{:>10s}{:>10s}\n'.format(cnt, 
                                                                             line[3], 
                                                                             '0.000'))
                            else:
                ...
                for line in self.merged_lib['[atoms]']:
                    ...
                    if line[1][0].islower()  == False:
                        if line[1] in self.backbone:
#                            if line[2] == 'C223' and self.mutation[0] == 'GLY':
#                                if fepfile == 'FEP1.fep':
#                                    outfile.write('{:4d}{:>10s}{:>10s}\n'.format(cnt, 
#                                                                                 'C223', 
#                                                                                 'C223'))
#                                elif fepfile == 'FEP2.fep':
#                                    outfile.write('{:4d}{:>10s}{:>10s}\n'.format(cnt, 
#                                                                                 'C223',
#                                                                                 'C224'))
#                                else:
                ...
                for line in self.merged_lib['[atoms]']:
                    ...
                    if line[1][0].islower()  == False:
                        if line[1] in self.backbone:
                            ...
                            if fepfile in ['FEP4.fep']:
                                outfile.write('{:4d}{:>10s}{:>10s}\n'.format(cnt, 
                                                                             '0', 
                                                                             '20'))
                            elif fepfile in ['FEP5.fep']:
                                outfile.write('{:4d}{:>10s}{:>10s}\n'.format(cnt, 
                                                                             '20', 
                                                                             '0'))
                            else:
                        ...
                        if fepfile in ['FEP1.fep']:
                            outfile.write('{:4d}{:>10s}{:>10s}\n'.format(cnt, 
                                                                         '0', 
                                                                         '20'))
                        elif fepfile in ['FEP2.fep']:
                            outfile.write('{:4d}{:>10s}{:>10s}\n'.format(cnt, 
                                                                         '20', 
                                                                         '0'))
                        else:
