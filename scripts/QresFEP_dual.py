...
class Run(object):
    ...
    def write_dualFEPfile(self):
        ...
        ## Edit_lucien: softcore endstates of DUM atoms turned off, no softcore at all
            ...
            with open(self.directory + '/inputfiles/' + fepfile, 'w') as outfile:
                ...
                for line in self.merged_lib['[atoms]']:
                    ...
                    if line[1][0].islower()  == False:
                        if line[1] in self.backbone or line[1] == 'HA2':    # Edit Lucien: it was also decharging backbone HA2 of GLY
