...
inputefiles_fep3=$workdir/inputfiles3
inputefiles_fep4=$workdir/inputfiles4
inputefiles_fep5=$workdir/inputfiles5
for inputfiles in "$inputefiles_fep1" "$inputefiles_fep2" "$inputefiles_fep3" "$inputefiles_fep4" "$inputefiles_fep5"; do
