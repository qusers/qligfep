...
workdir=/data1/s2904160/software_qligfep/both_endpoints_sampling/benzene_endpoint_sampling_no_softcore/waterleg
inputfiles=/data1/s2904160/software_qligfep/both_endpoints_sampling/benzene_endpoint_sampling_no_softcore/waterleg/inputfiles2
fepfile=FEP2.fep
fepdir=$workdir/FEP2
mkdir -p $fepdir
cd $fepdir
