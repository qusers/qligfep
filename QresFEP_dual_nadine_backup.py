...
class Run(object):
    ...
    def __init__(self, cofactor, mutation, include, forcefield, windows,
        ...
        self.atoms = {'CA': 0,
                      ...
                      'OD1': 0, 'od1': 0, 'OD2': 0, '0d2': 0,
                      'CE': 0, 'ce': 0, 'CE1': 0, 'ce1': 0, 'CE2': 0, 'ce2': 0,
    ...
    def check_switch(self, at1, at2):
        if self.atoms[at1] and self.atoms[at2]:
            return True
        else:
            return False
...
#        print(wt, mut)
        ...
        if len(wt) == 0:
            self.replacements['RES'] = '\n'
        else:
            for i in range(len(wt)):
                if not 'RES' in self.replacements:
                    self.replacements['RES']  = f'{self.atoms[wt[i]]} {self.atoms[mut[i]]} 0.0 0.1 10.0 0\n'
                else:
                    self.replacements['RES'] += f'{self.atoms[wt[i]]} {self.atoms[mut[i]]} 0.0 0.1 10.0 0\n'
