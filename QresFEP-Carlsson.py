...
class Run(object):
    ...
    def create_dual_lib(self):
        ...
        # Add CA CBx bond       Edit Lucien: or CA HA3 bond if MUT resn is GLY
        if self.ToGly == True:
            ...
            with open(self.directory + '/inputfiles/' + fepfile, 'w') as outfile:
                        ...
                        if line[1] in self.backbone:
                            ...
                            if fepfile in ['FEP1.fep', 'FEP2.fep']:
                                ...
                                outfile.write('{:4d}{:>10s}{:>10s}\n'.format(cnt, 
                                                                            line[3], 
                                                                            '0.000'))
                            elif fepfile in ['FEP4.fep', 'FEP5.fep']:
                                outfile.write('{:4d}{:>10s}{:>10s}\n'.format(cnt, 
                                                                            '0.000', 
                                                                            '0.000'))
                ...
                if self.FromGly == True or self.ToGly == True:
                    ...
                    if self.FromGly == True:
                        outfile.write('{:4s}{:8s}{:6s}{:10s}\n'.format('1','0.0','0.0','!C223 cb'))
                        outfile.write('{:4s}{:8s}{:6s}{:10s}\n'.format('2','536.0','1.529','!C224 cb'))
                    elif self.ToGly == True:
                        outfile.write('{:4s}{:8s}{:6s}{:10s}\n'.format('1','680.0','1.090','!C224 ha3'))
                        outfile.write('{:4s}{:8s}{:6s}{:10s}\n'.format('2','680.0','1.090','!C223 ha3'))
                    outfile.write('\n')
